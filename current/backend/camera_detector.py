...
class PersonDetector:
    ...
    def _start_recording(self):
        ...
        self.session_id, session_dir = self.session_manager.create_session()
        ...
        self.audio_recorder = AudioRecorder(str(audio_path))
        self.audio_recorder.start()
        
        self._recording = True
        self._current_recording_file = str(video_path)
